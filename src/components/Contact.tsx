        ...
        <div id="contact" className='pt-32 container'>
            <div className="grid md:grid-cols-2 gap-10">
                <div className="space-x-8">
                    ...
                    <p className='text-gray-400 text-[18px] pt-4'  data-aos="zoom-in-up">
                        Drop me a line, give me a call, or send me a message by submitting the form.
                    </p>
                    <div className="flex gap-4 items-center"  data-aos="zoom-in-up">
                        <AiOutlineMail size={30} /> sobiashenaz99@gmail.com
                    </div>
                    <div className="flex gap-4 items-center"  data-aos="zoom-in-up">
                        <BsTelephone size={30} /> (021) 345-0000
                    </div>
                </div>
                <div className="space-y-8">
                    ...
                    <div className="flex flex-col gap-1"  data-aos="zoom-in-up">
                        ...
                        <textarea className="bg-transparent border border-accent" id="message" rows={10}>
                        </textarea>
                    </div>
